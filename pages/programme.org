...
/Luca De Feo (CEA-Tech),/
/Nadia El Mrabet (Mines Saint-Étienne),/
/Simon Pontié (CEA-Tech)/
...
*** titre TODO -- Software Fault Injection at Runtime
    :PROPERTIES:
...
*** Méthodes pour la modélisation des injections de faute électromagnétiques
	...
	*Oualid Trabelsi* /(Télécom ParisTech),/
	/Laurent Savage	(Télécom ParisTech)/
...
*** titre TODO -- l'émulation post-silicon est-elle pertinente pour pré-qualifier un code?
    :PROPERTIES:
    :CUSTOM_ID: vinet
    :END:
